...
// 🔐 lit exactement tes clés "1"..."40" et variantes "_comment", "_images"
function getPointData(data, idx) {
  ...
  // on écarte toute valeur non-string ou base64 vide
  imgs = imgs.filter(s => typeof s === "string" && s.length > 16);
